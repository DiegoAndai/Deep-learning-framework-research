...
if os.path.exists('words.txt') and n == "w":
    ...
    reader.save_words()
    reader.save_train_papers("train_set")
    reader.save_test_papers("papers_to_classify")
    words = reader.words
...
def build_dataset(words):
    ...
    for word, _ in count:
        dictionary[word] = len(
            dictionary)  # create a dictionary of the most common words with unique integers as values.
